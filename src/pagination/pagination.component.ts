...
export interface UiPageChangedEvent {
    itemsPerPage: number;
    page: number;
}
...
@Component({
    ...
    template: `
      ...
      `,
    providers: [ValueAccessorProviderFactory(UiPaginationComponent)]
})
export class UiPaginationComponent implements ControlValueAccessor, OnInit {
    public config: any;
