...
import { UiPageChangedEvent } from './pagination.component';
...
@Component({
    ...
    providers: [ValueAccessorProviderFactory(UiPagerComponent)]
})
export class UiPagerComponent implements ControlValueAccessor, OnInit {
    public config: any;
    ...
    @Output() public pageChanged: EventEmitter<UiPageChangedEvent> = new EventEmitter<UiPageChangedEvent>();
    ...
    public constructor(renderer: Renderer, elementRef: ElementRef, paginationConfig: UiPaginationConfig) {
